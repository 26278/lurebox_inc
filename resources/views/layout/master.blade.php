...
<body>
    <div id="sidenavBackground" onclick="closeNav()"></div>
    ...
    <nav>
        ...
        <div class="cart-float" id="cart-menu" style="opacity: 0; ">
            <div class="float-text">
                <p>Winkelmandje</p>
                <svg class="close-btn" id="cart-close" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
            </div>
        ...
        <div class="menu-float" id="profile-menu" style="opacity: 0; display: none;">
            <div class="float-text">
                <p>Profiel</p>
                <svg class="close-btn" id="profile-close" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>            </div>
            <div class="float-links">
                <a class="nav-login" href="/login">Login</a>
                <a class="nav-register" href="/registreer">Registreer</a>
            </div>
        </div>
        ...
        <footer>
            ...
            <div class="footer-content-mobile">
                ...
                <div class="footer-frame">
                    <h2 class="footer-title">Vragen</h2>
                    <p class="footer-paragraph">
                        Heb je vragen of opmerkingen over onze 
                        service?
                    </p>
                    <a href="{{url('/faq')}}" class="footer-link">
                        Bekijk de FAQ of
